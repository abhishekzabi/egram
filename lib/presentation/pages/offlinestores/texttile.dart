...
import 'package:egram/presentation/pages/offlinestores/texttileadd.dart';
...
class _TextileState extends State<Textile> {
  final CollectionReference Textiledetailcollection =
      FirebaseFirestore.instance.collection('TextileDetails');
  int selectedIndex = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const TextileAdd()));
          },
          child: const Icon(
            Icons.add,
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/images/taylorpng.png")),
                ),
              ),
            ),
            Padding(
      ...
      body: StreamBuilder(
          stream: Textiledetailcollection.snapshots(),
