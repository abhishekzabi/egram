...
class OtherStoreAdd extends StatefulWidget {
  const OtherStoreAdd({super.key});

  @override
  State<OtherStoreAdd> createState() => _OtherStoreAdd();
}

class _OtherStoreAdd extends State<OtherStoreAdd> {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_storeformKey.currentState!.validate()) {
                              ...
                              Map<String, dynamic> otherStoreInfoMap = {
                                "id": id,
                              ...
                              await DatabaseMethod().otherStoreDetails(otherStoreInfoMap, id);
