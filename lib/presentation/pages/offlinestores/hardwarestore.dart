...
import 'package:egram/presentation/pages/offlinestores/hardwareadd.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:url_launcher/url_launcher.dart';

class HardwareStore extends StatefulWidget {
  const HardwareStore({super.key});

  @override
  State<HardwareStore> createState() => _HardwareStoreState();
}

class _HardwareStoreState extends State<HardwareStore> {
  final CollectionReference hardwarestoredetailcollection =
      FirebaseFirestore.instance.collection('HardwareStoreDetails');
  int selectedIndex = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const HardwareAdd()));
          },
          child: const Icon(
            Icons.add,
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/images/hardwarepng.png")),
                ),
              ),
            ),
            Padding(
      ...
      body: StreamBuilder(
          stream: hardwarestoredetailcollection.snapshots(),
    ...
    if (confirmDelete == true) {
      ...
      await hardwarestoredetailcollection
          .doc(id) // Use the document ID here
          .delete()
          .then((_) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Failed to delete store: $error"),
