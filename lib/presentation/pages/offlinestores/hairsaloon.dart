...
import 'package:egram/presentation/pages/offlinestores/hairsaloonadd.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:url_launcher/url_launcher.dart';

class HairSaloon extends StatefulWidget {
  const HairSaloon({super.key});

  @override
  State<HairSaloon> createState() => _HairSaloonState();
}

class _HairSaloonState extends State<HairSaloon> {
  final CollectionReference HairSaloondetailcollection =
      FirebaseFirestore.instance.collection('HairSaloonDetails');
  int selectedIndex = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const HairSaloonAdd()));
          },
          child: const Icon(
            Icons.add,
      ...
      body: StreamBuilder(
          stream: HairSaloondetailcollection.snapshots(),
    ...
    if (confirmDelete == true) {
      ...
      await HairSaloondetailcollection
