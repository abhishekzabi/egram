...
import 'package:egram/presentation/pages/offlinestores/otherstoreadd.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:url_launcher/url_launcher.dart';

class OtherStore extends StatefulWidget {
  const OtherStore({super.key});

  @override
  State<OtherStore> createState() => _OtherStoreState();
}

class _OtherStoreState extends State<OtherStore> {
  final CollectionReference OtherStoredetailcollection =
      FirebaseFirestore.instance.collection('OtherStoreDetails');
  int selectedIndex = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const OtherStoreAdd()));
          },
          child: const Icon(
            Icons.add,
      ...
      body: StreamBuilder(
          stream: OtherStoredetailcollection.snapshots(),
    ...
    if (confirmDelete == true) {
      ...
      await OtherStoredetailcollection
