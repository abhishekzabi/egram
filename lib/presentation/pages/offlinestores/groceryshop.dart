...
import 'package:egram/presentation/pages/offlinestores/groceryadd.dart';
...
class _GroceryStoreState extends State<GroceryStore> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const GroceryAdd()));
          },
          child: const Icon(
            Icons.add,
      ...
      body: StreamBuilder(
          stream: storedetailcollection.snapshots(),
