...
class TextileAdd extends StatefulWidget {
  const TextileAdd({super.key});

  @override
  State<TextileAdd> createState() => _TextileAdd();
}

class _TextileAdd extends State<TextileAdd> {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_storeformKey.currentState!.validate()) {
                              ...
                              Map<String, dynamic> textileInfoMap = {
                                "id": id,
                              ...
                              await DatabaseMethod().TextileDetails(textileInfoMap, id);
