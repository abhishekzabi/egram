...
class HardwareAdd extends StatefulWidget {
  ...
  @override
  State<HardwareAdd> createState() => _HardwareAdd();
}

class _HardwareAdd extends State<HardwareAdd> {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_storeformKey.currentState!.validate()) {
                              ...
                              Map<String, dynamic> hardwareStoreInfoMap = {
                                "id": id,
                              ...
                              await DatabaseMethod().hardwareStoreDetails(hardwareStoreInfoMap, id);
