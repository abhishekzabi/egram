...
class GoodsAddPage extends StatefulWidget {
  ...
  @override
  State<GoodsAddPage> createState() => _GoodsAddPage();
}

class _GoodsAddPage extends State<GoodsAddPage> {
  ...
  final _goodsformKey = GlobalKey<FormState>();
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      "Let's Add Goods/Pickup Details!",
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 24,
            ...
            const Padding(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                "Please Enter Valid Pickup Details.",
                style: TextStyle(
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_goodsformKey.currentState!.validate()) {
                              String id = randomAlphaNumeric(10);

                              Map<String, dynamic> goodsDriverInfoMap = {
                                "id": id,
                              ...
                              await DatabaseMethod()
                                  .goodsDriverDetails(goodsDriverInfoMap, id);

                              // Show success message
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(const SnackBar(
                                content: Text(
                                    'Pickup Details Added successfully!'),
