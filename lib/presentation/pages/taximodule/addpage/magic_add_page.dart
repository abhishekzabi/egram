...
class MagicAddPage extends StatefulWidget {
  const MagicAddPage({super.key});

  @override
  State<MagicAddPage> createState() => _MagicAddPage();
}

class _MagicAddPage extends State<MagicAddPage> {
        ...
        child: Column(
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                "Please Enter Valid Magic Iris Details.",
                style: TextStyle(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_autoformKey.currentState!.validate()) {
                              ...
                              Map<String, dynamic> magicirisDriverInfoMap = {
                                "id": id,
                              ...
                              await DatabaseMethod()
                                  .magicirisDriverDetails(magicirisDriverInfoMap, id);
