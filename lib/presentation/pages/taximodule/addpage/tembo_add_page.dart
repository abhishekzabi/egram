...
class TemboAddPage extends StatefulWidget {
  const TemboAddPage({super.key});

  @override
  State<TemboAddPage> createState() => _TemboAddPage();
}

class _TemboAddPage extends State<TemboAddPage> {
  ...
  final _lorryformKey = GlobalKey<FormState>();
        ...
        child: Column(
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                "Please Enter Valid Lorry Details.",
                style: TextStyle(
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_lorryformKey.currentState!.validate()) {
                              String id = randomAlphaNumeric(10);

                              Map<String, dynamic> temboDriverInfoMap = {
                                "id": id,
                              ...
                              await DatabaseMethod()
                                  .temboDriverDetails(temboDriverInfoMap, id);

                              // Show success message
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(const SnackBar(
                                content: Text(
                                    'Lorry Details Added successfully!'),
