...
class TaxiCarAddPage extends StatefulWidget {
  const TaxiCarAddPage({super.key});

  @override
  State<TaxiCarAddPage> createState() => _TaxiCarAddPage();
}

class _TaxiCarAddPage extends State<TaxiCarAddPage> {
        ...
        child: Column(
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 15, right: 15),
              child: Text(
                "Please Enter Valid TaxiCar Details.",
                style: TextStyle(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_autoformKey.currentState!.validate()) {
                              ...
                              Map<String, dynamic> taxicarDriverInfoMap = {
                                "id": id,
                              ...
                              await DatabaseMethod()
                                  .taxicarDriverDetails(taxicarDriverInfoMap, id);
