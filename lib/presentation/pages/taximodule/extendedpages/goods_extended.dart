...
class GoodsExtended extends StatefulWidget {
  String drivername;
  String drivernumber;
  ...
  @override
  State<GoodsExtended> createState() => _GoodsExtendedState();
}

class _GoodsExtendedState extends State<GoodsExtended> {
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  String documentid = widget.id;
                  await goodsDetailsCollection.doc(documentid).delete();
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text('Pickup details deleted successfully'),
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                _updateGoodsDetails(documentId);
                Navigator.of(context).pop();
              },
              child: const Text(
                "Update",
  ...
  Future<void> _updateGoodsDetails(String documentId) async {
    ...
    await goodsDetailsCollection.doc(documentId).update({
