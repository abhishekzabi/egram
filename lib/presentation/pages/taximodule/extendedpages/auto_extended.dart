...
class AutoExtended extends StatefulWidget {
  String drivername;
  String drivernumber;
  ...
  @override
  State<AutoExtended> createState() => _AutoExtendedState();
}

class _AutoExtendedState extends State<AutoExtended> {
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  String documentid = widget.id;
                  await autoDetailsCollection.doc(documentid).delete();
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text('AutoRikshaw details deleted successfully'),
  ...
  void _showEditDialog(String documentId) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text("Edit AutoRikshaw Details"),
          content: Column(
  ...
  Future<void> _updateBusDetails(String documentId) async {
    ...
    await autoDetailsCollection.doc(documentId).update({
