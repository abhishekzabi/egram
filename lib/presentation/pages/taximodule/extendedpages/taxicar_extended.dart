...
class TaxiCarExtended extends StatefulWidget {
  String drivername;
  String drivernumber;
  ...
  @override
  State<TaxiCarExtended> createState() => _TaxiCarExtendedState();
}

class _TaxiCarExtendedState extends State<TaxiCarExtended> {
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        width: 1,
                        color: const Color.fromARGB(142, 0, 150, 135)),
                    ...
                    children: [
                      ...
                      const Align(
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(left: 20, right: 20),
                          child: Text(
                            "Driver and taxi details may change. Please check for updates before your ride. ",
                            style: TextStyle(
                              fontSize: 14,
  ...
  void _deletetaxicardata(String documentid) {
    showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  String documentid = widget.id;
                  await taxicarDetailsCollection.doc(documentid).delete();
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text('Taxi Car details deleted successfully'),
  ...
  void _showEditDialog(String documentId) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text("Edit TaxiCar Details"),
          content: Column(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                _updateTaxiCarDetails(documentId);
                Navigator.of(context).pop();
              },
              child: const Text(
                "Update",
  ...
  Future<void> _updateTaxiCarDetails(String documentId) async {
    ...
    await taxicarDetailsCollection.doc(documentId).update({
