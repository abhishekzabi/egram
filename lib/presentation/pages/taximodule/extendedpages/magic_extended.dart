...
class MagicExtended extends StatefulWidget {
  String drivername;
  String drivernumber;
  ...
  @override
  State<MagicExtended> createState() => _MagicExtendedState();
}

class _MagicExtendedState extends State<MagicExtended> {
  ...
  void _deletemagicdata(String documentid) {
    showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  String documentid = widget.id;
                  await MagicDetailsCollection.doc(documentid).delete();
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text('Magic Iris details deleted successfully'),
  ...
  void _showEditDialog(String documentId) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text("Edit MagicIris Details"),
          content: Column(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                _updateMagicDetails(documentId);
                Navigator.of(context).pop();
              },
              child: const Text(
                "Update",
  ...
  Future<void> _updateMagicDetails(String documentId) async {
    ...
    await MagicDetailsCollection.doc(documentId).update({
