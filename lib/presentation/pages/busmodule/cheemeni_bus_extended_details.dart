...
class CheemeniBusExtendedDetails extends StatefulWidget {
  String busroute;
  String busname;
  String time;
  String id;
  CheemeniBusExtendedDetails({
    Key? key,
  ...
  @override
  State<CheemeniBusExtendedDetails> createState() => _CheemeniBusExtendedDetailsState();
}

class _CheemeniBusExtendedDetailsState extends State<CheemeniBusExtendedDetails> {
